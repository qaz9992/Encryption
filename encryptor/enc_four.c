...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "encryptor",
        "sources": [
            "encryptor\\enc_four.py",
            "encryptor\\enc_one.py",
            "encryptor\\enc_three.py",
            "encryptor\\enc_two.py"
        ]
    },
    "module_name": "encryptor"
}
END: Cython Metadata */
...
#define __PYX_HAVE__encryptor__enc_four
#define __PYX_HAVE_API__encryptor__enc_four
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "encryptor.enc_four" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "encryptor.enc_four"
extern int __pyx_module_is_main_encryptor__enc_four;
int __pyx_module_is_main_encryptor__enc_four = 0;

/* Implementation of "encryptor.enc_four" */
/* #### Code section: global_var ### */
static PyObject *__pyx_builtin_print;
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9encryptor_8enc_four_encrypt(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_message, PyObject *__pyx_v_seed_list, PyObject *__pyx_v_rand_min, PyObject *__pyx_v_rand_max); /* proto */
static PyObject *__pyx_pf_9encryptor_8enc_four_2decrypt(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_message, PyObject *__pyx_v_seed_list, PyObject *__pyx_v_rand_min, PyObject *__pyx_v_rand_max); /* proto */
...
#define __pyx_kp_u_Decrypted __pyx_string_tab[1]
#define __pyx_kp_u_Encrypted __pyx_string_tab[2]
#define __pyx_kp_u_Hello_World __pyx_string_tab[3]
#define __pyx_kp_u_Note_that_Cython_is_deliberately __pyx_string_tab[4]
#define __pyx_kp_u_Seed_list_must_be_the_same_lengt __pyx_string_tab[5]
#define __pyx_kp_u__2 __pyx_string_tab[6]
#define __pyx_kp_u_add_note __pyx_string_tab[7]
#define __pyx_kp_u_encryptor_enc_four_py __pyx_string_tab[8]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[9]
#define __pyx_n_u__3 __pyx_string_tab[10]
#define __pyx_n_u_and_key __pyx_string_tab[11]
...
#define __pyx_n_u_decrypt __pyx_string_tab[15]
#define __pyx_n_u_decrypted_message __pyx_string_tab[16]
#define __pyx_n_u_enc __pyx_string_tab[17]
#define __pyx_n_u_encrypt __pyx_string_tab[18]
#define __pyx_n_u_encrypted_message __pyx_string_tab[19]
#define __pyx_n_u_encryptor_enc_four __pyx_string_tab[20]
...
#define __pyx_n_u_rand_max __pyx_string_tab[34]
#define __pyx_n_u_rand_min __pyx_string_tab[35]
#define __pyx_n_u_randint __pyx_string_tab[36]
#define __pyx_n_u_random __pyx_string_tab[37]
#define __pyx_n_u_seed __pyx_string_tab[38]
#define __pyx_n_u_seed_list __pyx_string_tab[39]
...
#define __pyx_kp_b_iso88591_l_s_c_AQ_j_A_Q_e1IQa_s_3as_F_Q __pyx_string_tab[44]
#define __pyx_kp_b_iso88591_q_q_a_z_A_AV81Jj_E_as_1_s_c_AQ __pyx_string_tab[45]
...
/* Python wrapper */
static PyObject *__pyx_pw_9encryptor_8enc_four_1encrypt(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_9encryptor_8enc_four_1encrypt = {"encrypt", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9encryptor_8enc_four_1encrypt, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9encryptor_8enc_four_1encrypt(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_v_seed_list = 0;
  PyObject *__pyx_v_rand_min = 0;
  PyObject *__pyx_v_rand_max = 0;
  #if !CYTHON_METH_FASTCALL
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_message,&__pyx_mstate_global->__pyx_n_u_seed_list,&__pyx_mstate_global->__pyx_n_u_rand_min,&__pyx_mstate_global->__pyx_n_u_rand_max,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "encrypt", 0) < (0)) __PYX_ERR(0, 3, __pyx_L3_error)
      if (!values[1]) values[1] = __Pyx_NewRef(((PyObject*)Py_None));
      if (!values[2]) values[2] = __Pyx_NewRef(((PyObject *)((PyObject*)__pyx_mstate_global->__pyx_int_1)));
      if (!values[3]) values[3] = __Pyx_NewRef(((PyObject *)((PyObject*)__pyx_mstate_global->__pyx_int_255)));
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("encrypt", 0, 1, 4, i); __PYX_ERR(0, 3, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  4:
    ...
    __pyx_v_seed_list = ((PyObject*)values[1]);
    __pyx_v_rand_min = values[2];
    __pyx_v_rand_max = values[3];
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("encrypt", 0, 1, 4, __pyx_nargs); __PYX_ERR(0, 3, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("encryptor.enc_four.encrypt", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_seed_list), (&PyList_Type), 1, "seed_list", 2))) __PYX_ERR(0, 3, __pyx_L1_error)
  __pyx_r = __pyx_pf_9encryptor_8enc_four_encrypt(__pyx_self, __pyx_v_message, __pyx_v_seed_list, __pyx_v_rand_min, __pyx_v_rand_max);
...
static PyObject *__pyx_pf_9encryptor_8enc_four_encrypt(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_message, PyObject *__pyx_v_seed_list, PyObject *__pyx_v_rand_min, PyObject *__pyx_v_rand_max) {
  int __pyx_v_and_key;
  ...
  __Pyx_INCREF(__pyx_v_seed_list);

  /* "encryptor/enc_four.py":4
 * 
 * def encrypt(message, seed_list: list=None, rand_min=1, rand_max=255):
 *     random.seed(None)             # <<<<<<<<<<<<<<
 *     and_key = False
...
*/
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_random); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_seed); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
...
*/
  __pyx_t_6 = (__pyx_v_seed_list == ((PyObject*)Py_None));
  if (__pyx_t_6) {

    /* "encryptor/enc_four.py":7
 *     and_key = False
 *     if seed_list is None:
 *         and_key = True             # <<<<<<<<<<<<<<
 *         seed_list = [random.randint(rand_min, rand_max) for _ in range(len(message))]
...
*/
    { /* enter inner scope */
      ...
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_7 = PyObject_Length(__pyx_v_message); if (unlikely(__pyx_t_7 == ((Py_ssize_t)-1))) __PYX_ERR(0, 8, __pyx_L1_error)
      __pyx_t_8 = __pyx_t_7;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_7genexpr__pyx_v__ = __pyx_t_9;
        __pyx_t_2 = NULL;
        __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_random); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 8, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_randint); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 8, __pyx_L1_error)
        ...
        #endif
        {
          PyObject *__pyx_callargs[3] = {__pyx_t_2, __pyx_v_rand_min, __pyx_v_rand_max};
    ...
    __Pyx_DECREF_SET(__pyx_v_seed_list, ((PyObject*)__pyx_t_1));
    __pyx_t_1 = 0;
 ...
 *     enc = ''
*/
  if (unlikely(__pyx_v_seed_list == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "object of type 'NoneType' has no len()");
    __PYX_ERR(0, 9, __pyx_L1_error)
  }
  __pyx_t_7 = __Pyx_PyList_GET_SIZE(__pyx_v_seed_list); if (unlikely(__pyx_t_7 == ((Py_ssize_t)-1))) __PYX_ERR(0, 9, __pyx_L1_error)
  __pyx_t_8 = PyObject_Length(__pyx_v_message); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(0, 9, __pyx_L1_error)
  __pyx_t_6 = (__pyx_t_7 != __pyx_t_8);
  if (unlikely(__pyx_t_6)) {

    /* "encryptor/enc_four.py":10
 *         seed_list = [random.randint(rand_min, rand_max) for _ in range(len(message))]
 *     if len(seed_list) != len(message):
 *         raise ValueError("Seed list must be the same length as the message.")             # <<<<<<<<<<<<<<
 *     enc = ''
...
*/
    ...
    __pyx_t_5 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_4, __pyx_mstate_global->__pyx_kp_u_Seed_list_must_be_the_same_lengt};
...
*/
  ...
  __pyx_v_enc = __pyx_mstate_global->__pyx_kp_u_;

  /* "encryptor/enc_four.py":12
 *         raise ValueError("Seed list must be the same length as the message.")
 *     enc = ''
 *     index = 0             # <<<<<<<<<<<<<<
 *     for i in message:
...
*/
  if (likely(PyList_CheckExact(__pyx_v_message)) || PyTuple_CheckExact(__pyx_v_message)) {
    __pyx_t_1 = __pyx_v_message; __Pyx_INCREF(__pyx_t_1);
    __pyx_t_8 = 0;
    __pyx_t_11 = NULL;
  } else {
    __pyx_t_8 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_v_message); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_11 = (CYTHON_COMPILING_IN_LIMITED_API) ? PyIter_Next : __Pyx_PyObject_GetIterNextFunc(__pyx_t_1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  for (;;) {
...
*/
    __pyx_t_10 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_random); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_seed); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_2 = __Pyx_PyObject_GetItem(__pyx_v_seed_list, __pyx_v_index); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_5 = 1;
    #if CYTHON_UNPACK_METHODS
 ...
 *     if and_key:
*/
    __pyx_t_12 = __Pyx_PyObject_Ord(__pyx_v_i); if (unlikely(__pyx_t_12 == ((long)(long)(Py_UCS4)-1))) __PYX_ERR(0, 15, __pyx_L1_error)
    __pyx_t_4 = __Pyx_PyLong_From_long(__pyx_t_12); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_10, __pyx_mstate_global->__pyx_n_u_random); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_mstate_global->__pyx_n_u_randint); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 15, __pyx_L1_error)
    ...
    __pyx_t_13 = PyNumber_Xor(__pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_14 = __Pyx_PyLong_As_int(__pyx_t_13); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __pyx_t_13 = PyUnicode_FromOrdinal(__pyx_t_14); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_3 = __Pyx_PyUnicode_Concat__Pyx_ReferenceSharing_OwnStrongReferenceInPlaceSafe(__pyx_v_enc, __pyx_t_13); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __Pyx_DECREF_SET(__pyx_v_enc, ((PyObject*)__pyx_t_3));
    __pyx_t_3 = 0;

    /* "encryptor/enc_four.py":16
 *         random.seed(seed_list[index])
 *         enc += chr(ord(i) ^ random.randint(rand_min, rand_max))
 *         index += 1             # <<<<<<<<<<<<<<
 *     if and_key:
...
*/
    __pyx_t_3 = __Pyx_PyLong_AddObjC(__pyx_v_index, __pyx_mstate_global->__pyx_int_1, 1, 1, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 16, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
...
*/
    ...
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_v_enc) != (0)) __PYX_ERR(0, 18, __pyx_L1_error);
    __Pyx_INCREF(__pyx_v_seed_list);
    __Pyx_GIVEREF(__pyx_v_seed_list);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_1, 1, __pyx_v_seed_list) != (0)) __PYX_ERR(0, 18, __pyx_L1_error);
    __pyx_r = __pyx_t_1;
    __pyx_t_1 = 0;
    goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_9encryptor_8enc_four_3decrypt(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_9encryptor_8enc_four_3decrypt = {"decrypt", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9encryptor_8enc_four_3decrypt, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9encryptor_8enc_four_3decrypt(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "decrypt", 0) < (0)) __PYX_ERR(0, 21, __pyx_L3_error)
      if (!values[2]) values[2] = __Pyx_NewRef(((PyObject *)((PyObject*)__pyx_mstate_global->__pyx_int_1)));
      if (!values[3]) values[3] = __Pyx_NewRef(((PyObject *)((PyObject*)__pyx_mstate_global->__pyx_int_255)));
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("decrypt", 0, 2, 4, i); __PYX_ERR(0, 21, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  4:
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decrypt", 0, 2, 4, __pyx_nargs); __PYX_ERR(0, 21, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("encryptor.enc_four.decrypt", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_seed_list), (&PyList_Type), 0, "seed_list", 2))) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_r = __pyx_pf_9encryptor_8enc_four_2decrypt(__pyx_self, __pyx_v_message, __pyx_v_seed_list, __pyx_v_rand_min, __pyx_v_rand_max);
...
static PyObject *__pyx_pf_9encryptor_8enc_four_2decrypt(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_message, PyObject *__pyx_v_seed_list, PyObject *__pyx_v_rand_min, PyObject *__pyx_v_rand_max) {
  PyObject *__pyx_v_enc = NULL;
  PyObject *__pyx_v_index = NULL;
  PyObject *__pyx_v_i = NULL;
  PyObject *__pyx_r = NULL;
 ...
 *     enc = ''
*/
  __pyx_t_1 = __Pyx_PyList_GET_SIZE(__pyx_v_seed_list); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_2 = PyObject_Length(__pyx_v_message); if (unlikely(__pyx_t_2 == ((Py_ssize_t)-1))) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_3 = (__pyx_t_1 != __pyx_t_2);
  if (unlikely(__pyx_t_3)) {

    /* "encryptor/enc_four.py":23
 * def decrypt(message, seed_list: list, rand_min=1, rand_max=255):
 *     if len(seed_list) != len(message):
 *         raise ValueError("Seed list must be the same length as the message.")             # <<<<<<<<<<<<<<
 *     enc = ''
...
*/
    ...
    __pyx_t_6 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_5, __pyx_mstate_global->__pyx_kp_u_Seed_list_must_be_the_same_lengt};
...
*/
  if (likely(PyList_CheckExact(__pyx_v_message)) || PyTuple_CheckExact(__pyx_v_message)) {
    __pyx_t_4 = __pyx_v_message; __Pyx_INCREF(__pyx_t_4);
    __pyx_t_2 = 0;
    __pyx_t_7 = NULL;
  } else {
    __pyx_t_2 = -1; __pyx_t_4 = PyObject_GetIter(__pyx_v_message); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
...
*/
    __pyx_t_8 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_9, __pyx_mstate_global->__pyx_n_u_random); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_mstate_global->__pyx_n_u_seed); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = __Pyx_PyObject_GetItem(__pyx_v_seed_list, __pyx_v_index); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_6 = 1;
    #if CYTHON_UNPACK_METHODS
    if (unlikely(PyMethod_Check(__pyx_t_10))) {
 ...
 *     return enc
*/
    __pyx_t_11 = __Pyx_PyObject_Ord(__pyx_v_i); if (unlikely(__pyx_t_11 == ((long)(long)(Py_UCS4)-1))) __PYX_ERR(0, 28, __pyx_L1_error)
    __pyx_t_5 = __Pyx_PyLong_From_long(__pyx_t_11); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_9 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_random); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_12 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_randint); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 28, __pyx_L1_error)
    ...
    #endif
    {
      PyObject *__pyx_callargs[3] = {__pyx_t_9, __pyx_v_rand_min, __pyx_v_rand_max};
    ...
    __pyx_t_12 = PyNumber_Xor(__pyx_t_5, __pyx_t_10); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __pyx_t_13 = __Pyx_PyLong_As_int(__pyx_t_12); if (unlikely((__pyx_t_13 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_12 = PyUnicode_FromOrdinal(__pyx_t_13); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_10 = __Pyx_PyUnicode_Concat__Pyx_ReferenceSharing_OwnStrongReferenceInPlaceSafe(__pyx_v_enc, __pyx_t_12); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __Pyx_DECREF_SET(__pyx_v_enc, ((PyObject*)__pyx_t_10));
    __pyx_t_10 = 0;

    /* "encryptor/enc_four.py":29
 *         random.seed(seed_list[index])
 *         enc += chr(ord(i) ^ random.randint(rand_min, rand_max))
 *         index += 1             # <<<<<<<<<<<<<<
 *     return enc
 * 
*/
    __pyx_t_10 = __Pyx_PyLong_AddObjC(__pyx_v_index, __pyx_mstate_global->__pyx_int_1, 1, 1, 0); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
...
static int __pyx_pymod_exec_enc_four(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_enc_four},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_enc_four(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_enc_four(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_enc_four(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'enc_four' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "enc_four" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_enc_four", 0);
  ...
  if (__pyx_module_is_main_encryptor__enc_four) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "encryptor.enc_four")) {
      if (unlikely((PyDict_SetItemString(modules, "encryptor.enc_four", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_seed_list, __pyx_mstate_global->__pyx_n_u_list) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)
  __pyx_t_3 = __Pyx_CyFunction_New(&__pyx_mdef_9encryptor_8enc_four_1encrypt, 0, __pyx_mstate_global->__pyx_n_u_encrypt, NULL, __pyx_mstate_global->__pyx_n_u_encryptor_enc_four, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_encrypt, __pyx_t_3) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_seed_list, __pyx_mstate_global->__pyx_n_u_list) < (0)) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9encryptor_8enc_four_3decrypt, 0, __pyx_mstate_global->__pyx_n_u_decrypt, NULL, __pyx_mstate_global->__pyx_n_u_encryptor_enc_four, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_decrypt, __pyx_t_2) < (0)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "encryptor/enc_four.py":32
 *     return enc
 * 
 * if __name__ == "__main__":             # <<<<<<<<<<<<<<
 *     message = "Hello, World!"
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = (__Pyx_PyUnicode_Equals(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_main, Py_EQ)); if (unlikely((__pyx_t_4 < 0))) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_4) {

    /* "encryptor/enc_four.py":33
 * 
 * if __name__ == "__main__":
 *     message = "Hello, World!"             # <<<<<<<<<<<<<<
 *     encrypted_message, seed_list = encrypt(message)
...
*/
    if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_message, __pyx_mstate_global->__pyx_kp_u_Hello_World) < (0)) __PYX_ERR(0, 33, __pyx_L1_error)

    /* "encryptor/enc_four.py":34
 * if __name__ == "__main__":
 *     message = "Hello, World!"
 *     encrypted_message, seed_list = encrypt(message)             # <<<<<<<<<<<<<<
 *     print(f"Encrypted: {encrypted_message}")
...
*/
    __pyx_t_3 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_encrypt); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_message); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 34, __pyx_L1_error)
    ...
    if ((likely(PyTuple_CheckExact(__pyx_t_2))) || (PyList_CheckExact(__pyx_t_2))) {
      ...
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = __Pyx_PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      #endif
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    } else {
    ...
    if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_encrypted_message, __pyx_t_5) < (0)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_seed_list, __pyx_t_6) < (0)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;

    /* "encryptor/enc_four.py":35
 *     message = "Hello, World!"
 *     encrypted_message, seed_list = encrypt(message)
 *     print(f"Encrypted: {encrypted_message}")             # <<<<<<<<<<<<<<
 *     decrypted_message = decrypt(encrypted_message, seed_list)
...
*/
    __pyx_t_6 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_encrypted_message); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_3 = __Pyx_PyObject_FormatSimple(__pyx_t_5, __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyUnicode_Concat(__pyx_mstate_global->__pyx_kp_u_Encrypted, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_7 = 1;
    {
...
*/
    __pyx_t_5 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_decrypt); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 36, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_encrypted_message); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 36, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_GetModuleGlobalName(__pyx_t_9, __pyx_mstate_global->__pyx_n_u_seed_list); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 36, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_7 = 1;
    {
      PyObject *__pyx_callargs[3] = {__pyx_t_5, __pyx_t_3, __pyx_t_9};
    ...
    if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_decrypted_message, __pyx_t_2) < (0)) __PYX_ERR(0, 36, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

    /* "encryptor/enc_four.py":37
 *     print(f"Encrypted: {encrypted_message}")
 *     decrypted_message = decrypt(encrypted_message, seed_list)
 *     print(f"Decrypted: {decrypted_message}")             # <<<<<<<<<<<<<<
*/
    __pyx_t_6 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_9, __pyx_mstate_global->__pyx_n_u_decrypted_message); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_3 = __Pyx_PyObject_FormatSimple(__pyx_t_9, __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = __Pyx_PyUnicode_Concat(__pyx_mstate_global->__pyx_kp_u_Decrypted, __pyx_t_3); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_7 = 1;
    {
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init encryptor.enc_four", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init encryptor.enc_four");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
\355\375\032L\237N\345uT76\256l\031\225\237|\\\355T\235\352\274nn\225\243j\275\332\256\033\317JJ?/;u\243Y>)\347\031\364m\177R\235W\274n\276(\255\217\374G\317\275\255^W\307\323\267\263hvxM\254mO\265\233e\373~m\327\377\231n\316>_\217\203\326\233r\354\327\353\306V\311C\317\277~\307w\352\346K\037\325\315W\276\343\177U\007\323\366\364\373lt\323\270\351\336\356\336\362[{\027\335\265\377\227\275\215\253q\240\344\344!X\375\007t\273T\301";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (881 bytes) */
const char* const bytes = "Decrypted: Encrypted: Hello, World!Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.Seed list must be the same length as the message.?add_noteencryptor/enc_four.py__Pyx_PyDict_NextRef_and_keyasyncio.coroutines__class_getitem__cline_in_tracebackdecryptdecrypted_messageencencryptencrypted_messageencryptor.enc_four__func__iindex_is_coroutineitemslist__main__message__module____name__popprint__qualname__rand_maxrand_minrandintrandomseedseed_list__set_name__setdefault__test__values\320\000 \240\006\240l\260!\330\004\007\200s\210!\210;\220c\230\023\230A\230Q\330\010\016\210j\230\001\230\021\330\004\n\210!\330\004\014\210A\330\004\010\210\005\210Q\330\010\016\210e\2201\220I\230Q\230a\330\010\017\210s\220!\2203\220a\220s\230\"\230F\240(\250!\250:\260Q\330\010\021\220\021\330\004\013\2101\320\000\025\220[\240\013\250<\260q\330\004\n\210%\210q\220\001\330\004\016\210a\330\004\007\200z\220\023\220A\330\010\022\220!\330\010\024\220A\220V\2308\2401\240J\250j\270\004\270E\300\025\300a\300s\310!\3101\330\004\007\200s\210!\210;\220c\230\023\230A\230Q\330\010\016\210j\230\001\230\021\330\004\n\210!\330\004\014\210A\330\004\010\210\005\210Q\330\010\016\210e\2201\220I\230Q\230a\330\010\017\210s\220!\2203\220a\220s\230\"\230F\240(\250!\250:\260Q\330\010\021\220\021\330\004\007\200q\330\010\017\210u\220A\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {4, 0, 0, 9, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 3};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_message, __pyx_mstate->__pyx_n_u_seed_list, __pyx_mstate->__pyx_n_u_rand_min, __pyx_mstate->__pyx_n_u_rand_max, __pyx_mstate->__pyx_n_u_and_key, __pyx_mstate->__pyx_n_u_enc, __pyx_mstate->__pyx_n_u_index, __pyx_mstate->__pyx_n_u_i, __pyx_mstate->__pyx_n_u__3};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_encryptor_enc_four_py, __pyx_mstate->__pyx_n_u_encrypt, __pyx_mstate->__pyx_kp_b_iso88591_q_q_a_z_A_AV81Jj_E_as_1_s_c_AQ, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {4, 0, 0, 7, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 21};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_message, __pyx_mstate->__pyx_n_u_seed_list, __pyx_mstate->__pyx_n_u_rand_min, __pyx_mstate->__pyx_n_u_rand_max, __pyx_mstate->__pyx_n_u_enc, __pyx_mstate->__pyx_n_u_index, __pyx_mstate->__pyx_n_u_i};
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_encryptor_enc_four_py, __pyx_mstate->__pyx_n_u_decrypt, __pyx_mstate->__pyx_kp_b_iso88591_l_s_c_AQ_j_A_Q_e1IQa_s_3as_F_Q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
